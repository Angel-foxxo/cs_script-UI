export const FONT_DEFINITIONS = `_HEADER_TEXT_
...
export const FONT_CLASS = `export const _FONT_NAME_: Font = new Font("_FONT_NAME_", _LINE_HEIGHT_, [
_FONT_METRICS_
]);
`;

export const FONT_METRIC =
    `    { pixelW:_WIDTH_, pixelH:_HEIGHT_, advance:_ADVANCE_ }, // _CHAR_`;

export const VTEX = `<!-- dmx encoding keyvalues2_noids 1 format vtex 1 -->
"CDmeVtex"
{
...
export const FONT_PARTICLE = `<!-- kv3 encoding:text:version{e21c7f3c-8a33-41c5-9977-a76d3a32aa0d} format:vpcf65:version{48e806a9-c210-4cd8-811a-38b5ef63b195} -->
{
...
export const VMAP = `<!-- dmx encoding keyvalues2 4 format vmap 29 -->
"CMapRootElement"
{
